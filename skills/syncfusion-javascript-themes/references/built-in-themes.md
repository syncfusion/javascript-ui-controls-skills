...
- [Individual Control Themes](#individual-control-themes)
- [Optimized (Lite) CSS Files](#optimized-lite-css-files)

## Available Themes

Syncfusion JavaScript controls provide multiple modern themes with light and dark variants:
...
{
  "dependencies": {
    "@syncfusion/ej2-grids": "33.1.44"  // Your version
  }
}
```
...
> **Note:** Check your installed version with `npm list @syncfusion/ej2-buttons` before using CDN links.