...
- [Icons in Syncfusion Controls](#icons-in-syncfusion-controls)
- [Available Icons by Theme](#available-icons-by-theme)

## Overview

Syncfusion provides a comprehensive icon library with pre-designed, font-based icons embedded in themes. Icons ensure visual consistency across controls and are available via npm or CDN.
...
const downloadButton: Button = new Button({
...
// Icon only button
const searchButton: Button = new Button({
  iconCss: 'e-icons e-search'
});
searchButton.appendTo('#searchButton');
```
