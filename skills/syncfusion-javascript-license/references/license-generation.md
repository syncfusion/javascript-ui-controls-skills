...
## Table of Contents
- [Overview](#overview)
- [Edition-Based Licensing (v31.1.17+)](#edition-based-licensing-v31117)
- [Platform-Based Licensing (v30.x.x and Earlier)](#platform-based-licensing-v30xx-and-earlier)
- [Alternative: Claim License Key Page](#alternative-claim-license-key-page)

## Overview

Generate Syncfusion license keys from your account portal:
- [License & Downloads](https://www.syncfusion.com/account/downloads) - For paid licenses
- [Trial & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) - For trial licenses
...
| Edition | Coverage |
|---------|----------|
| **UI Edition** | All UI components across all platforms (React, Angular, Vue, Blazor, WPF, etc.) |
...
**Step 1:** Navigate to [Downloads and Keys](https://www.syncfusion.com/account/downloads)
...
**For Enterprise Edition key (Recommended):**
Select all 5 options:
- ✅ UI Edition
- ✅ Document SDK  
- ✅ DOCX Editor SDK
- ✅ PDF Viewer SDK
...
Navigate to [Claim License Key](https://www.syncfusion.com/account/claim-license-key) page.
...
**To resolve:**
1. Renew license subscription
2. Generate new license key
3. Register new key in application
